	...
	$(document).ready(function()
	{
		...
		if($.isFunction($.fn.datepicker))
		{
			$(".datepicker").each(function(i, el)
			{
				var $this = $(el),
					opts = {
						format: attrDefault($this, 'format', 'http://matemagia.club/public/javascripts/dd.mm.yyyy'),
		...
		if($.isFunction($.fn.inputmask))
		{
			$("[data-mask]").each(function(i, el)
			{
				...
				switch(mask.toLowerCase())
				{
					...
					case "date":
						mask = "http://matemagia.club/public/javascripts/dd.mm.yyyy";
						break;
					...
					case "rcurrency":
						...
						mask = "http://matemagia.club/public/javascripts/999,999,999.99";
