/**
 *	Matemagia Club Forgot Password Script
 */
...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		neonForgotPassword.$container.validate({
			...
			messages: {
				email: {
                    required: "Көрсету керек",
					email: 'Дұрыс емес E-mail.'
				}	
			},
							...
							success: function(response)
							{
								...
								setTimeout(function()
								{
                                    if (response.status == "success") {
                                        ...
                                        neonForgotPassword.$steps.slideDown('normal', function () {
                                            $(".login-page").removeClass('logging-in');

                                            if (response.field == "email") {
                                                $("#email-error").slideDown('normal');
                                            } else {
                                                $("#unknown-error").slideDown('normal');
                                            }
                                        });
                                    }
